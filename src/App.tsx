    ...
    return (
        <>
            ...
            <PageContainer>
                ...
                <InnerPageContainer>
                    <p className="text-xl text-left">Tretet unserem Newsletter bei, um mit uns die Zukunft der Musikbranche mitzugestalten! Bleibt über alle Entwicklungen informiert und verpasst keine News. Die ersten 100 Anmeldungen kriegen einen Gutschein zum Launch der Plattform im Januar 2024.</p>
                </InnerPageContainer>
